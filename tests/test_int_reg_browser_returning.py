...
final_col_list_browser_returning = df.columns.to_list()
# %% Split the data
...
# %% save df
feature_importance.to_csv('feature_importance_4model_noscore_browser_returning', index=False)
########## PREDICTIONS ##########
# %%
import joblib
# %% load
...
# %%
df_pred = load_the_data('/home/ron.snir/git/loss_model/data/pi4_browser_returning_immature000.csv')
# %%
# %%
...
# %%
df_pred = df_pred[final_col_list_browser_returning]
# %%
...
# %%
predicted_unpaid_browser_returning = df_pred_features_pred['predicted_unpaid_rate_at_60'].mean()
# %%
