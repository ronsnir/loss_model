...
# %%
threshold=0.025
probs = model_report(model=model, model_name='catboost', threshold=threshold, X_train=X_train, X_test=X_test, y_train=y_train, y_validation=y_validation, y_test=y_test)
